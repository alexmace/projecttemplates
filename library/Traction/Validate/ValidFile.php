...
class Traction_Validate_ValidFile extends Zend_Validate_Abstract
{

    const INI_SIZE = 'iniSize';     // Value: 1; The uploaded file exceeds the
                                    // upload_max_filesize directive in php.ini
    const FORM_SIZE = 'formSize';   // Value: 2; The uploaded file exceeds the
                                    // MAX_FILE_SIZE directive that was
                                    // specified in the HTML form
    const PARTIAL = 'partial';      // Value: 3; The uploaded file was only
                                    // partially uploaded
    const NO_FILE = 'noFile';       // Value: 4; No file was uploaded
    const NO_TMP_DIR = 'noTmpDir';  // Value: 5; Missing a temporary folder
    const CANT_WRITE = 'cantWrite'; // Value: 6; Failed to write file to disk
    const EXTENSION = 'extension';  // Value: 7; File upload stopped by
                                    // extension
    const ERROR = 'error';          // General error for future proofing
                                    // against new PHP versions
     ...
     *
     * Returns true if and only if $value['error'] is UPLOAD_ERR_OK
     *
